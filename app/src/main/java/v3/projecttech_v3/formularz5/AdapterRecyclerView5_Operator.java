...
import static v3.projecttech_v3.formularz5.Operator_Activity.FinalListWithCellColor;
import static v3.projecttech_v3.formularz5.Operator_Activity.FinalListWithColumnsAdjust;
import static v3.projecttech_v3.formularz5.Operator_Activity.database_Operator;
import static v3.projecttech_v3.formularz5.Operator_Activity.inputOperator2;
...
public class AdapterRecyclerView5_Operator extends RecyclerView.Adapter<AdapterRecyclerView5_Operator.ViewHolderRecyclerView> {
    ...
    public AdapterRecyclerView5_Operator(Context context1, ArrayList<ArrayList<String>> dataIn, RecyclerViewInterface5_Operator recyclerViewInterface) {
    ...
    @NonNull
    @Override
    public AdapterRecyclerView5_Operator.ViewHolderRecyclerView onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater inflater = LayoutInflater.from(context);
        View view = inflater.inflate(R.layout.formularz5_linear_layout_rows5_operator, parent, false);
        return new ViewHolderRecyclerView(view, recyclerViewInterface);
    }

    @Override
    public void onBindViewHolder(@NonNull AdapterRecyclerView5_Operator.ViewHolderRecyclerView holder, int position) {

        holder.textView1.setText(database_Operator.get(position).get(0).toString());
        holder.textView2.setText(database_Operator.get(position).get(1).toString());
        holder.textView3.setText(database_Operator.get(position).get(2).toString());
        holder.textView4.setText(database_Operator.get(position).get(3).toString());
        holder.textView5.setText(database_Operator.get(position).get(4).toString());
        holder.textView6.setText(database_Operator.get(position).get(5).toString());
        holder.textView7.setText(database_Operator.get(position).get(6).toString());
        holder.textView8.setText(database_Operator.get(position).get(7).toString());
    ...
    public class ViewHolderRecyclerView extends RecyclerView.ViewHolder {
        ...
        public ViewHolderRecyclerView(@NonNull View itemView, RecyclerViewInterface5_Operator recyclerViewInterface)
        {
            super(itemView);
