...
public class AdapterRecyclerView5_Maszyna extends RecyclerView.Adapter<AdapterRecyclerView5_Maszyna.ViewHolderRecyclerView> {
    ...
    public AdapterRecyclerView5_Maszyna(Context context1, ArrayList<ArrayList<String>> dataIn, RecyclerViewInterface5_Maszyna recyclerViewInterface) {
    ...
    @Override
    public void onBindViewHolder(@NonNull AdapterRecyclerView5_Maszyna.ViewHolderRecyclerView holder, int position) {

        holder.textView1.setText(database_Maszyna.get(position).get(0).toString());
        holder.textView2.setText(database_Maszyna.get(position).get(1).toString());
        holder.textView3.setText(database_Maszyna.get(position).get(2).toString());
        holder.textView4.setText(database_Maszyna.get(position).get(3).toString());
        holder.textView5.setText(database_Maszyna.get(position).get(4).toString());
        holder.textView6.setText(database_Maszyna.get(position).get(5).toString());
        holder.textView7.setText(database_Maszyna.get(position).get(6).toString());
    ...
    public class ViewHolderRecyclerView extends RecyclerView.ViewHolder {
        ...
        public ViewHolderRecyclerView(@NonNull View itemView, RecyclerViewInterface5_Maszyna recyclerViewInterface)
        {
            super(itemView);
