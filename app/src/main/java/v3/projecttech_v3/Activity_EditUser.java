...
import static v3.projecttech_v3.Activity_Login.intentEnterData;
...
public class Activity_EditUser extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textViewEdycjaDanych = findViewById(R.id.textViewEdycjaDanych);
        textViewMaszJuzKonto = findViewById(R.id.textViewMaszJuzKonto);

        ImageView imageLogo2 = findViewById(R.id.imageLogo2);
        Button buttonEdycjaDanych = findViewById(R.id.buttonEdycjaDanych);

        String tmpUserMail = intentEditdata.getStringExtra("emailUser");
        Log.i("checking", tmpUserMail.toString());
//        emailUser = dataBaseSQLUser.getDataMail(tmpUserMail).getMail();

        inputEmail.setText(tmpUserMail);

        Log.i("checking", "databaseSQLUser " + dataBaseSQLUser.getAllData().get(1).getMail());


        buttonEdycjaDanych.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
//                Boolean isAllFieldsValidateTrue = CheckAllFields();
                takingValuesFromInputTextView();
                Intent intentRegister = new Intent(Activity_EditUser.this, Activity_Login.class);

                if (CheckAllFields()) {
                    Log.i("checking", "MailtmpInsertData2: " + tmpInsertData.getMail());
                    Log.i("checking", "ImietmpInsertData2: " + tmpInsertData.getImie());
                    dataBaseSQLUser.updateDataByMail(tmpInsertData);
                    Toast.makeText(getApplicationContext(), "Zmiana danych przebiegła pomyślnie", Toast.LENGTH_LONG).show();
        ...
        textViewMaszJuzKonto.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intentMamJuzKonto = new Intent(Activity_EditUser.this, Activity_Login.class);
    ...
    public Data5 takingValuesFromInputTextView() {
        ...
        Log.i("checking", "MailtmpInsertData: " + tmpInsertData.getMail());
        Log.i("checking", "ImietmpInsertData: " + tmpInsertData.getImie());
