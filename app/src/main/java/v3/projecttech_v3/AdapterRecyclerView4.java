...
public class AdapterRecyclerView4 extends RecyclerView.Adapter<AdapterRecyclerView4.ViewHolderRecyclerView> {
    ...
    public AdapterRecyclerView4 (Context context1, ArrayList<ArrayList<String>> dataIn, RecyclerViewInterface recyclerViewInterface) {
    ...
    public void onBindViewHolder(@NonNull AdapterRecyclerView4.ViewHolderRecyclerView holder, int i) {
        ...
        holder.textView1_4.setText(dataBaseSQL.getDataId(i+1).getRawColor());
        holder.textView2_4.setText(dataBaseSQL.getDataId(i+1).getLock());
        holder.textView3_4.setText(dataBaseSQL.getDataId(i+1).getLp());
        holder.textView4_4.setText(dataBaseSQL.getDataId(i+1).getMagazyn());
        holder.textView5_4.setText(dataBaseSQL.getDataId(i+1).getLokalizacja());
        holder.textView6_4.setText(dataBaseSQL.getDataId(i+1).getPartia());
        holder.textView7_4.setText(dataBaseSQL.getDataId(i+1).getWariant());
        holder.textView8_4.setText(dataBaseSQL.getDataId(i+1).getWariantOpis());
        holder.textView9_4.setText(dataBaseSQL.getDataId(i+1).getPartiaZlecenie());
        holder.textView10_4.setText(dataBaseSQL.getDataId(i+1).getKonfekcja());
        holder.textView11_4.setText(dataBaseSQL.getDataId(i+1).getIlwkonf());
        holder.textView12_4.setText(dataBaseSQL.getDataId(i+1).getIlszt());
        holder.textView13_4.setText(dataBaseSQL.getDataId(i+1).getIloscKm());
        holder.textView14_4.setText(dataBaseSQL.getDataId(i+1).getRez());
        holder.textView15_4.setText(dataBaseSQL.getDataId(i+1).getSource());

        holder.textView1_4.setBackgroundColor(Color.parseColor(FinalListWithCellColor.get(i)));
        holder.textView2_4.setBackgroundColor(Color.parseColor(FinalListWithCellColor.get(i)));
        holder.textView3_4.setBackgroundColor(Color.parseColor(FinalListWithCellColor.get(i)));
        holder.textView4_4.setBackgroundColor(Color.parseColor(FinalListWithCellColor.get(i)));
        holder.textView5_4.setBackgroundColor(Color.parseColor(FinalListWithCellColor.get(i)));
        holder.textView6_4.setBackgroundColor(Color.parseColor(FinalListWithCellColor.get(i)));
        holder.textView7_4.setBackgroundColor(Color.parseColor(FinalListWithCellColor.get(i)));
        holder.textView8_4.setBackgroundColor(Color.parseColor(FinalListWithCellColor.get(i)));
        holder.textView9_4.setBackgroundColor(Color.parseColor(FinalListWithCellColor.get(i)));
        holder.textView10_4.setBackgroundColor(Color.parseColor(FinalListWithCellColor.get(i)));
        holder.textView11_4.setBackgroundColor(Color.parseColor(FinalListWithCellColor.get(i)));
        holder.textView12_4.setBackgroundColor(Color.parseColor(FinalListWithCellColor.get(i)));
        holder.textView13_4.setBackgroundColor(Color.parseColor(FinalListWithCellColor.get(i)));
        holder.textView14_4.setBackgroundColor(Color.parseColor(FinalListWithCellColor.get(i)));
        holder.textView15_4.setBackgroundColor(Color.parseColor(FinalListWithCellColor.get(i)));

        holder.textView1_4.setGravity(FinalListWithColumnsAdjust.get(0));
        holder.textView2_4.setGravity(FinalListWithColumnsAdjust.get(1));
        holder.textView3_4.setGravity(FinalListWithColumnsAdjust.get(2));
        holder.textView4_4.setGravity(FinalListWithColumnsAdjust.get(3));
        holder.textView5_4.setGravity(FinalListWithColumnsAdjust.get(4));
        holder.textView6_4.setGravity(FinalListWithColumnsAdjust.get(5));
        holder.textView7_4.setGravity(FinalListWithColumnsAdjust.get(6));
        holder.textView8_4.setGravity(FinalListWithColumnsAdjust.get(7));
        holder.textView9_4.setGravity(FinalListWithColumnsAdjust.get(8));
        holder.textView10_4.setGravity(FinalListWithColumnsAdjust.get(9));
        holder.textView11_4.setGravity(FinalListWithColumnsAdjust.get(10));
        holder.textView12_4.setGravity(FinalListWithColumnsAdjust.get(11));
        holder.textView13_4.setGravity(FinalListWithColumnsAdjust.get(12));
        holder.textView14_4.setGravity(FinalListWithColumnsAdjust.get(13));
        holder.textView15_4.setGravity(FinalListWithColumnsAdjust.get(14));
